...
<span id="time">5</span>秒后自动跳转，如果不跳转，请点击链接:<a href="articleDetail.jsp?id=<%=rootId%>">主题列表</a>
<script type="text/javascript">delayURL("articleDetail.jsp?id=<%=rootId%>");</script>
